...
class CustomL1HintIOBundle(implicit p: Parameters) extends L3Bundle {
  // input information
...
class CustomL1Hint(implicit p: Parameters) extends L3Module {
  ...
  val s3_l2_hit_grant_data = task_s3.valid && !mshr_req_s3 && !need_mshr_s3 && task_s3.bits.fromA && task_s3.bits.opcode === AcquireBlock && !task_s3.bits.fromL3pft.getOrElse(false.B)
  val s4_l2_hit_grant_data = task_s4.valid && req_grantbuffer_next_cycle_s4 && task_s4.bits.opcode === GrantData && task_s4.bits.fromA && !task_s4.bits.mshrTask && !task_s4.bits.fromL3pft.getOrElse(false.B)
  ...
  val s3_l2_miss_refill_grant_data    = d_s3 && mshr_req_s3 && task_s3.bits.fromA && task_s3.bits.opcode === GrantData && !task_s3.bits.fromL3pft.getOrElse(false.B)
  ...
  // S4 hint
  //    * l1 acquire and l2 miss situation
  val s4_l2_miss_refill_grant_data    = d_s4 && task_s4.bits.opcode === GrantData && task_s4.bits.fromA && task_s4.bits.mshrTask && !task_s4.bits.fromL3pft.getOrElse(false.B)
  ...
  // S5 hint
  //    * l1 acquire and l2 hit situation
  val validHint_s5 = d_s5 && task_s5.bits.opcode === GrantData && task_s5.bits.fromA && !task_s5.bits.mshrTask && ((globalCounter + 1.U) === hintCycleAhead.U) && !task_s5.bits.fromL3pft.getOrElse(false.B)
  // S5 hint
  //    * l1 acquire and l2 miss situation
  val validHintMiss_s5 = d_s5 && task_s5.bits.opcode === GrantData && task_s5.bits.fromA && task_s5.bits.mshrTask && ((globalCounter + 1.U) === hintCycleAhead.U) && !task_s5.bits.fromL3pft.getOrElse(false.B)
